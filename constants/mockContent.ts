...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'c2', title: 'Los Bridgerton', posterUrl: 'https://picsum.photos/seed/c2/200/300', description: 'La alta sociedad londinense navega el escándalo y el romance en la temporada social.', year: 2020, rating: 'TV-MA', duration: 'Serie', genre: 'Drama, Romance' },
